...
function createPartitionedHiearchy(
  ...
  if (chartType === "TREE_MAP") {
    const treeMapPartition = treemap<GitObject>()
      .tile(treemapResquarify.ratio(1)) // treemapSlice в нужную сторону, но нарезается слишком мелко, не оставляет высоты. Resquarify - помогает реже двигаться тайлам
